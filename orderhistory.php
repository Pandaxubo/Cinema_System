<?php
session_start();
$seatsdetail = $_SESSION['seatsdetail'];
?>
<!doctype html>
<html lang="en">
<head>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    ...
                    <label class="btn btn-secondary" onclick="window.location.href='profile-payinfo.html'">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        ...
                        <div class="card" id="action">
                            <div class="card-body">
                                <h5><?php echo $_SESSION['moviename'];?></h5>
                                <p>
                                    Ticket count: <?php echo $_SESSION['totalseats'];?><br>
                                    Date: <?php echo $_SESSION['showdate']?><br>
                                    Show Time: <?php echo $_SESSION['showtime']?><br>
                                    Seats:  <?php foreach ($seatsdetail AS $seatsdetail):?>
                                        <?php echo $seatsdetail;?>
                                    <?php endforeach;?><br>
